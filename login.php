...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
    <title>Admin Login | HarmonyFiveHijab</title>
  </head>
  <body class="body-bg ">
    <nav class="navbar navbar-expand-lg navbar-dark navbar-bg ">
  <a class="navbar-brand logo-brand" href="#" style="font-size:30px;"><strong>HarmonyFiveHijab</strong></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <img class="z-3 " src="./images/logo1.png" style="width: 50%; " alt="Card image cap">
    <h5>HarmonyFiveHijab</h5>
    </div>
